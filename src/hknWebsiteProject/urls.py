...
urlpatterns = [
    ...
    url(r'^create_new_members/', 'hknWebsiteProject.views.create_new_members',
        name='create_new_members'),
    url(r'^edit_electee_requirements/', 'electeeManagement.views.edit_electee_requirements',
    ...
    url(r'^submit_service_hours/', 'electeeManagement.views.submit_service_hours',
        name='submit_service_hours'),
    url(r'^electee_submission_approval/(?P<approved>[0-1])$',
        'electeeManagement.views.electee_submission_approval', name='electee_submission_approval'),
    url(r'^electee_submission_approval/', 'electeeManagement.views.electee_submission_approval',
    ...
    url(r'^edit_leadership/(?P<position_added>[0-1])/$', 'leadership.views.edit_leadership',
    ...
    url(r'^initilize_electee_requirements/',
        'electeeManagement.views.initilize_electee_requirements',
    ...
    url(r'^db_cafe/items_edit/(?P<item>[a-z A-Z]{1,120})/$', 'dbcafe.views.items_edit',
        name='items_edit'),
    ...
    url(r'^/misc_tools/(?P<success>[0-1])/$', 'hknWebsiteProject.views.misc_tools',
        name='misc_tools'),
    url(r'^/misc_tools', 'hknWebsiteProject.views.misc_tools', name='misc_tools'),
    url(r'^/email_uncompleted_profiles', 'hknWebsiteProject.views.email_uncompleted_profiles',
        name='email_uncompleted_profiles'),
